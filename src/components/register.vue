...
const validateFields = () => {
  ...
  if (password.value !== password_confirm.value) errors.value.push("The two passwords do not match.")
  ...
  <div class="page-container">
    <div class="card auth-card">
      ...
      <div class="form-group">
        ...
        <input v-model="user" @keyup.enter="register" type="text" class="input" :disabled="disabled" required />
      </div>

      <div class="form-group">
        <label>Email</label>
        <input v-model="email" @keyup.enter="register" type="email" class="input" :disabled="disabled" required />
      </div>

      <div class="form-group">
        <label>Password</label>
        <input v-model="password" @keyup.enter="register" type="password" class="input" :disabled="disabled" required />
      </div>

      <div class="form-group">
        <label>Confirm Password</label>
        <input v-model="password_confirm" @keyup.enter="register" type="password" class="input" :disabled="disabled" required />
      </div>
